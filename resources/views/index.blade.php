...
<main>
    ...
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="img/soldier.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading" style="color: yellow">Experience the Adrenaline Rush. Get in the game.</h2>
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading" style="color: yellow">Test Your Skills and Strategy. Victory awaits.</h2>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading" style="color: yellow">Create Unforgettable Memories. Capture the moment.</h2>
      ...
      <div class="col-md-5">
        <img class="featurette-image img-fluid mx-auto" width="500" height="500" src="img/bottom3.jpg">
